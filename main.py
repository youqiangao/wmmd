...
parser.add_argument("-ts", "--train-size", type = float, required = True, help = "training size")
parser.add_argument("-bs", "--batch-size", type = int, required = True, help = "batch size")
parser.add_argument("-es", "--embed-size", type = int, required = True, help = "embedding size")
