...
Example: To train a `CNN` model on the `ChileEarthquakeT1` dataset with the `wMMD` (weight = 10^3), `l1` (weight = 10^3) or `dropout` (dropout-rate = 0.5), repsectively execute the following commands:
```shell
